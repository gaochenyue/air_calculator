...
<user username="username">
  ...
  <!--display in tree-->
  <funclibrary dllpath="users\anonymous\library\" sourcepath="users\anonymous\source\">
  ...
  <!--display in grid-->
  <imagelibrary ipath="users\anonymous\image\">
    <image name="test">
      <name>test</name>
      <expression>cos(x^2+y^2)</expression>
      <type>users/anonymous/image/test.jpeg</type>
    </image>
    <image name="test2">
      <name>test2</name>
      <expression>(x^2)/4-(y^2)/9</expression>
      <type>users/anonymous/image/test2.jpeg</type>
    </image>
    <image name="test3">
      <name>test3</name>
      <expression>sin(x^2+y^2)</expression>
      <type>users/anonymous/image/test3.jpeg</type>
    </image>
    <image name="test4">
      <name>test4</name>
      <expression>x^2+y^2</expression>
      <type>users/anonymous/image/test4.jpeg</type>
    </image>
    <image name="test5">
      <name>test5</name>
      <expression>x^3+y^3</expression>
      <type>users/anonymous/image/test5.jpeg</type>
    </image>
    <image name="test6">
      <name>test6</name>
      <expression>sin(x+y)</expression>
      <type>users/anonymous/image/test6.jpeg</type>
    </image>
    <image name="test7">
      <name>test7</name>
      <expression>sin(x)</expression>
      <type>users/anonymous/image/test7.jpeg</type>
    </image>
    <image name="test8">
      <name>test8</name>
      <expression>cos(x)</expression>
      <type>users/anonymous/image/test8.jpeg</type>
    </image>
    <image name="test9">
      <name>test9</name>
      <expression>x^3+x^2+x+1</expression>
      <type>users/anonymous/image/test9.jpeg</type>
    </image>
    <image name="test10">
      <name>test10</name>
      <expression>1/x</expression>
      <type>users/anonymous/image/test10.jpeg</type>
    </image>
    <image name="test11">
      <name>test11</name>
      <expression>sin(sqrt(x)+sqrt(y))</expression>
      <type>users/anonymous/image/test11.jpeg</type>
    </image>
  </imagelibrary>
  <!--display in grid-->
  <variable>
