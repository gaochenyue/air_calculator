 ...
 */
Ext.ux.XmlTreeLoader2 = Ext.extend(Ext.tree.TreeLoader, {
    /**
    ...
    processResponse : function(response, node, callback){
        ...
        var root = xmlData.getElementsByTagName("toolbox")[xmlData.getElementsByTagName("toolbox").length-1];//alert(xmlData.getElementsByTagName("toolbox").length);
    ...
    createNode : function(node){
        ...
        attr.text=node.childNodes[0].text;
