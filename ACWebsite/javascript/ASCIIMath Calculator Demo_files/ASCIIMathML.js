...
//AC supllement
{input:"asin",  tag:"mo", output:"arcsin", tex:null, ttype:UNARY, func:true},
{input:"acos",  tag:"mo", output:"arccos", tex:null, ttype:UNARY, func:true},
{input:"atan",  tag:"mo", output:"arctan", tex:null, ttype:UNARY, func:true},
{input:"acot",  tag:"mo", output:"arccot", tex:null, ttype:UNARY, func:true},
{input:"asinh",  tag:"mo", output:"arcsinh", tex:null, ttype:UNARY, func:true},
{input:"acosh",  tag:"mo", output:"arccosh", tex:null, ttype:UNARY, func:true},
{input:"atanh",  tag:"mo", output:"arctanh", tex:null, ttype:UNARY, func:true},
{input:"acoth",  tag:"mo", output:"arccoth", tex:null, ttype:UNARY, func:true},
{input:"acsc",  tag:"mo", output:"arccsc", tex:null, ttype:UNARY, func:true},
{input:"acsch",  tag:"mo", output:"arccsch", tex:null, ttype:UNARY, func:true},
{input:"asec",  tag:"mo", output:"arcsec", tex:null, ttype:UNARY, func:true},
{input:"asech",  tag:"mo", output:"arcsech", tex:null, ttype:UNARY, func:true},
{input:"inf",  tag:"mo", output:"\u221E", tex:null, ttype:CONST},
{input:"factor",  tag:"mo", output:"Factor", tex:null, ttype:UNARY, func:true},
{input:"combine",  tag:"mo", output:"Combine", tex:null, ttype:UNARY, func:true},
{input:"expand",  tag:"mo", output:"Expand", tex:null, ttype:UNARY, func:true},
{input:"laplace",  tag:"mo", output:"Laplace", tex:null, ttype:UNARY, func:true},
{input:"taylor",  tag:"mo", output:"Taylor", tex:null, ttype:UNARY, func:true},
{input:"solve",  tag:"mo", output:"solve", tex:null, ttype:UNARY, func:true},
{input:"undefined",  tag:"mo", output:"undefined", tex:null, ttype:UNARY, func:true},
//arrows
